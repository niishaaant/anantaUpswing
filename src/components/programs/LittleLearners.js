		...
		<ThemeProvider theme={theme2}>
			<MainGridLeft img={child}>
				<Typography
					...
					gutterBottom
				>
					Little Learners : Parent Child Program
				</Typography>
				<hr />
				<br />
				<Typography
				...
				<Typography className={classes.bodyText} paragraph>
					A program designed specially for Hearing Impaired kids aged{' '}
					<Typography display='inline' className={classes.bold}>
						{' '}
						3 years – 4 years
					</Typography>
					, With an aim to provide a language enriched environment in order to
					develop Spoken Language through listening & to mainstream in a formal
					school.
				</Typography>
				<Typography className={classes.bodyText} paragraph>
				...
				<Typography className={classes.bodyText} paragraph>
					Our multi-disciplinary approach with emphasis on assisting each child
					to reach their full potential. The sessions are individualized to each
					child’s need and integrate many disciplines such as Audiologist,
					Speech Pathologists, Special Educator, Psychologists, Occupational
					Therapists, Early childhood Specialist & Music therapist.
				</Typography>
			</MainGridLeft>
